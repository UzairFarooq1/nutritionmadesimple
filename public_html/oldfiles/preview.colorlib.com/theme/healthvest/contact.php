...
<div class="text">
<p><span>Email:</span><a href="mailto:rdbenazir@nutritionmadesimple.uk">rdbenazir@nutritionmadesimple.uk</a></p>
</div>
</div>
</div>
<div class="col-md-4">
...
<h2 class="mb-2">Your Trusted Dietitian and Nutritionist</h2>
...
<form action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSeMXIoXIEO_lpu7vLg4lFZqeIdJwPy2KANZbSfsW8J_7RpfDw/formResponse" method="post" target="hidden_iframe" onsubmit="return validateForm();" class="appointment" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
...
<input class="form-control" type="text" placeholder="Name" id="name" required name="entry.1795247421">
</div>
</div>
<div class="col-md-12 col-lg-6">
<div class="form-group">
<label for="email">Email Address</label>
<input  class="form-control" type="email" placeholder="Email" id="email" required name="entry.1511555087">
</div>
</div>
<div class="col-md-12">
<div class="form-group">
...
<input class="form-control" type="phone" placeholder="Phone" id="phone" required name="entry.1824205660">
</div>
</div>
<div class="col-md-12">
<div class="form-group">
<label for="message">Message</label>
<textarea  id="message" cols="30" rows="7" class="form-control" placeholder="Message" required name="entry.1289840507" ></textarea>
